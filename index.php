...
<div id="servicos">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2  fadeInLeft wow" data-wow-delay="0.15s">
...
<div id="sobre" class=" fadeIn wow" data-wow-delay="0.3s">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<p class=" fadeInUp wow" data-wow-delay="0.3s">Todas as nossas soluções são feitas sob medida, não importa o tamanho do seu projeto ou o porte da sua empresa. 
				Nosso objetivo é criar experiências únicas e verdadeiras para aproximar o cliente da sua marca.</p>
				<p class=" fadeInUp wow" data-wow-delay="0.3s"><strong>Somos um time extremamente focado</strong> no ambiente digital. É pensando em entregar soluções que superam as expectativas, que nos faz desenvolver projetos digitais que transformam a vida das empresas para melhor. </p>
				<p class=" fadeInUp wow" data-wow-delay="0.3s">Conte com a Seimi Digital para elaborar e executar o marketing digital da sua empresa. </p>
				<p class=" fadeInUp wow" data-wow-delay="0.3s"><strong>Nos comprometemos ao máximo com seu projeto, porque amamos o que fazemos!</strong></p>
			</div>
		</div>
	</div>
</div>
